...
| 容器 | 旧数据卷 | 新数据卷 | 状态 |
|------|---------|---------|------|
| `tradingagents-mongodb` | `tradeToolkit_tradingagents_mongodb_data_v1` | `tradingagents_mongodb_data` | ✅ 完成 |
| `tradingagents-redis` | `tradeToolkit_tradingagents_redis_data_v1` | `tradingagents_redis_data` | ✅ 完成 |
...
| `tradeToolkit_tradingagents_mongodb_data_v1` | ✅ 已删除 |
| `tradeToolkit_tradingagents_redis_data_v1` | ✅ 已删除 |
| 6 个匿名数据卷 | ✅ 已删除 |
