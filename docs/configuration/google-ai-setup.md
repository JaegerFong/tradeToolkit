...
本指南将帮助您配置Google AI (Gemini)模型，以便在tradeToolkit中使用Google的强大AI能力进行股票分析。

## 🎯 概述

tradeToolkit v0.1.2新增了对Google AI的完整支持，包括：
...
1. 📖 查看 [完整文档](../README.md)
2. 🧪 运行 [测试程序](../../tests/)
3. 💬 提交 [GitHub Issue](https://github.com//tradeToolkit/issues)
