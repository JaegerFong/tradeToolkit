...
**tradeToolkit** 是一个基于多智能体架构的 AI 股票分析系统，支持：
...
**推荐**：如果只是运行 tradeToolkit，选择 **Hyper-V 模式**更简单！
...
# 2. 下载部署文件
Invoke-WebRequest -Uri "https://raw.githubusercontent.com//tradeToolkit/v1.0.0-preview/docker-compose.hub.nginx.yml" -OutFile "docker-compose.hub.nginx.yml"

# 3. 下载环境配置文件
Invoke-WebRequest -Uri "https://raw.githubusercontent.com//tradeToolkit/v1.0.0-preview/.env.docker" -OutFile ".env"
...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com//tradeToolkit/v1.0.0-preview/nginx/nginx.conf" -OutFile "nginx\nginx.conf"
...
# 2. 下载部署文件
wget https://raw.githubusercontent.com//tradeToolkit/v1.0.0-preview/docker-compose.hub.nginx.yml

# 3. 下载环境配置文件
wget https://raw.githubusercontent.com//tradeToolkit/v1.0.0-preview/.env.docker -O .env
...
# 5. 下载 Nginx 配置文件
mkdir -p nginx
wget https://raw.githubusercontent.com//tradeToolkit/v1.0.0-preview/nginx/nginx.conf -O nginx/nginx.conf
...
# 2. 下载 ARM 架构部署文件（重要！）
curl -O https://raw.githubusercontent.com//tradeToolkit/v1.0.0-preview/docker-compose.hub.nginx.arm.yml

# 3. 下载环境配置文件
curl -o .env https://raw.githubusercontent.com//tradeToolkit/v1.0.0-preview/.env.docker
...
# 5. 下载 Nginx 配置文件
mkdir -p nginx
curl -o nginx/nginx.conf https://raw.githubusercontent.com//tradeToolkit/v1.0.0-preview/nginx/nginx.conf
...
- **GitHub Issues**: https://github.com//tradeToolkit/issues
- **文档**: https://github.com//tradeToolkit/tree/v1.0.0-preview/docs
- **示例**: https://github.com//tradeToolkit/tree/v1.0.0-preview/examples
