...
```bash
# 下载并运行部署脚本
curl -fsSL https://raw.githubusercontent.com/your-org/tradeToolkit/main/scripts/deploy_demo.sh | bash
```
...
```bash
# 克隆仓库
git clone https://github.com/your-org/tradeToolkit.git
cd tradeToolkit
```
...
curl -o docker-compose.hub.yml https://raw.githubusercontent.com/your-org/tradeToolkit/main/docker-compose.hub.yml

# 下载环境变量模板
curl -o .env.example https://raw.githubusercontent.com/your-org/tradeToolkit/main/.env.example

# 下载配置数据
curl -o install/database_export_config_2025-10-16.json https://raw.githubusercontent.com/your-org/tradeToolkit/main/install/database_export_config_2025-10-16.json

# 下载导入脚本
curl -o scripts/import_config_and_create_user.py https://raw.githubusercontent.com/your-org/tradeToolkit/main/scripts/import_config_and_create_user.py
