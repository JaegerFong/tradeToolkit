...
> 5分钟快速上手 tradeToolkit v1.0.0-preview
...
- 关注公众号 "tradeToolkit" 获取网盘链接

操作手册：

https://mp.weixin.qq.com/s/uAk4RevdJHMuMvlqpdGUEw
tradeToolkit v1.0.0-preview绿色版（目前只支持windows）简单使用手册
https://mp.weixin.qq.com/s/o5QdNuh2-iKkIHzJXCj7vQ
tradeToolkit v1.0.0-preview绿色版绿色版端口配置说明
---
...
# 2. 创建项目目录
mkdir tradeToolkit && cd tradeToolkit
...
- **GitHub Issues**: [提交问题](https://github.com//tradeToolkit/issues)
- **微信公众号**: tradeToolkit
- **QQ 群**: 关注公众号获取群号
