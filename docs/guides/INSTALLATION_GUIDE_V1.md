# tradeToolkit v1.0.0-preview 安装指南
...
tradeToolkit 提供三种部署方式，请根据您的需求选择：
...
- **GitHub Releases**: [https://github.com//tradeToolkit/releases](https://github.com//tradeToolkit/releases)
- **百度网盘**: 关注公众号 "tradeToolkit" 获取下载链接
- **阿里云盘**: 关注公众号 "tradeToolkit" 获取下载链接
...
2. **下载 docker-compose.yml**：
   ```bash
   # 从 GitHub 下载
   curl -O https://raw.githubusercontent.com//tradeToolkit/main/docker-compose.yml
...
3. **创建 .env 文件**：
   ```bash
   # 复制示例配置
   curl -O https://raw.githubusercontent.com//tradeToolkit/main/.env.example
   mv .env.example .env
...
1. **克隆代码**：
   ```bash
   git clone https://github.com//tradeToolkit.git
   cd tradeToolkit
   ```
...
1. **查看文档**: [docs/](../)
2. **GitHub Issues**: [https://github.com//tradeToolkit/issues](https://github.com//tradeToolkit/issues)
3. **微信公众号**: tradeToolkit
4. **QQ 群**: 关注公众号获取群号
