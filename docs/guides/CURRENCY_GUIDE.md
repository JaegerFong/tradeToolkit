...
tradeToolkit 支持多种货币单位的模型定价，不同的 LLM 厂家使用不同的货币进行计费。

tradeToolkit supports multiple currency units for model pricing. Different LLM providers use different currencies for billing.
...
- 📧 邮箱 / Email: 
- 💬 QQ群 / QQ Group: 
- 🌐 GitHub: https://github.com//tradeToolkit
