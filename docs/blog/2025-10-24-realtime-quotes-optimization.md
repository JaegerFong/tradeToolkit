...
docker build --platform linux/amd64 -t tradeToolkit:amd64 .
docker tag tradeToolkit:amd64 your-registry/tradeToolkit:amd64
docker push your-registry/tradeToolkit:amd64

# ARM64 架构（Apple Silicon/ARM服务器）
docker build --platform linux/arm64 -t tradeToolkit:arm64 .
docker tag tradeToolkit:arm64 your-registry/tradeToolkit:arm64
docker push your-registry/tradeToolkit:arm64
```
...
```bash
# AMD64 用户
docker pull your-registry/tradeToolkit:amd64

# ARM64 用户
docker pull your-registry/tradeToolkit:arm64
```
...
如有问题或建议，欢迎在 [GitHub Issues](https://github.com//tradeToolkit/issues) 中反馈。
