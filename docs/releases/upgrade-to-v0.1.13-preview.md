...
本指南将帮助您从 tradeToolkit v0.1.12 升级到 v0.1.13，享受原生OpenAI支持和Google AI全面集成的新功能。
...
# 症状: Google API密钥无效
# 解决方案:
# 1. 检查密钥格式是否符合 Google AI Studio 返回的实际格式
# 2. 确认密钥权限
# 3. 检查API配额
```
...
恭喜！您已成功升级到 tradeToolkit v0.1.13。
