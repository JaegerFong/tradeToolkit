...
```bash
# 从 Docker Hub 拉取（最快）
docker pull /tradingagents-backend:v1.0.0-preview-amd64
docker pull /tradingagents-frontend:v1.0.0-preview-amd64
```
...
# image: /tradingagents-backend:v1.0.0-preview-amd64
...
1. 查看构建日志
2. 检查 Docker 版本和配置
3. 提交 Issue：[GitHub Issues](https://github.com//tradeToolkit/issues)
