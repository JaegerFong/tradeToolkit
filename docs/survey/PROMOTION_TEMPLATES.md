...
### 主题行选项
1. `📊 tradeToolkit 用户调查 - 您的意见很重要`
2. `🎁 参与调查，赢取大模型 API 额度`
3. `帮助我们改进 tradeToolkit - 5 分钟问卷`
4. `您的反馈将决定 tradeToolkit 的未来`
...
感谢您使用 tradeToolkit！作为一个开源的 AI 股票分析工具，我们一直致力于为用户提供更好的产品体验。
...
### Issue 标题
```
📊 用户调查 | tradeToolkit User Survey - 您的意见很重要！
```
...
**相关链接**
- 📖 [项目文档](https://github.com//tradeToolkit/wiki)
- 💬 [讨论区](https://github.com//tradeToolkit/discussions)
