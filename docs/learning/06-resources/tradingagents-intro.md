...
tradeToolkit是基于**TradingAgents**项目开发的中文本地化版本。TradingAgents是一个开源的AI驱动的多智能体股票分析平台，由Tauric Research团队开发。本文将介绍TradingAgents项目的背景、核心理念和技术架构。
...
tradeToolkit在TradingAgents的基础上进行了大量本地化改进：
...
- 🌐 [GitHub仓库](https://github.com//tradeToolkit)
- 📚 [中文文档](../../README.md)
- 💬 [问题反馈](https://github.com//tradeToolkit/issues)
...
TradingAgents是一个创新的开源股票分析平台，通过多智能体协作和大语言模型，为股票分析提供了新的解决方案。tradeToolkit在此基础上进行了深度本地化，使其更适合中国市场和中文用户。
...
**Q: TradingAgents和tradeToolkit有什么区别？**

A: tradeToolkit是TradingAgents的中文本地化版本，增加了对中国市场的支持，优化了用户体验，并提供了更完善的中文文档。

**Q: 可以商业使用吗？**

A: 可以。TradingAgents和tradeToolkit都采用开源许可证，允许商业使用。但请注意遵守相关金融法规。
