  ...
  <div class="about">
      ...
      <div class="hero-content">
        <div class="hero-text">
          ...
          <div class="hero-acknowledgment">
            ...
            <span>基于 <a href="https://github.com/TauricResearch/TradingAgents" target="_blank" rel="noopener noreferrer">TradingAgents</a> 项目进行二次开发，感谢原项目的贡献</span>
          </div>
    ...
    <div class="origin-section">
      <div class="section-header">
        ...
        <p class="section-subtitle">合规使用上游开源组件</p>
      </div>
      ...
      <div class="origin-content">
        <div class="origin-card">
          ...
          <div class="origin-description">
            <p>
              本项目基于 <strong>TradingAgents</strong>（上游开源项目）进行二次开发与工程化集成。
              具体授权范围与署名要求请以仓库内的许可证文件为准。
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="contact-section">
      <div class="section-header">
        ...
        <p class="section-subtitle">部署、配置与使用说明</p>
      </div>
      ...
      <div class="contact-grid">
        <div class="contact-card">
          ...
          <span class="contact-desc">如部署在非根路径，请按你的站点路由调整</span>
        </div>
      </div>
    </div>
    ...
    <div class="footer-section">
      <div class="footer-content">
        <p>&copy; 2025 tradeToolkit. All rights reserved.</p>
