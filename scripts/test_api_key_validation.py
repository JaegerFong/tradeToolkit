...
def test_api_key_validation():
    ...
    test_cases = [
        ...
        ("valid_api_key_value_for_unit_tests_001", True, "有效的 API Key"),
        ("valid_api_key_value_for_unit_tests_002", True, "有效的 API Key"),
        ("valid_google_key_value_for_unit_tests_003", True, "有效的 Google API Key"),
        ("valid_qianfan_key_value_for_unit_tests_004", True, "有效的千帆 API Key"),
        ("valid_openrouter_key_value_for_unit_tests_005", True, "有效的 OpenRouter API Key"),
        ('"valid_api_key_value_for_unit_tests_006"', True, "带引号的有效 API Key"),
        ("'valid_api_key_value_for_unit_tests_007'", True, "带单引号的有效 API Key"),
    ]
