...
def create_release_tag():
    ...
    tag_name = "cn-v0.1.2"
    tag_message = "tradeToolkit v0.1.2 - Web管理界面和Google AI支持"
...
def show_release_summary():
    """显示发布摘要"""
    logger.info(f"\n")
    logger.info(f"🎉 tradeToolkit v0.1.2 发布准备完成！")
    logger.info(f"=")
...
def main():
    """主函数"""
    logger.info(f"🚀 tradeToolkit v0.1.2 版本发布")
    logger.info(f"=")
