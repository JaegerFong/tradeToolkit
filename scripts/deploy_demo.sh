...
GITHUB_REPO="https://github.com/your-org/tradeToolkit"
GITHUB_RAW="https://raw.githubusercontent.com/your-org/tradeToolkit/main"
...
show_info() {
    ...
    echo ""
    echo -e "${BLUE}文档:${NC}"
    echo -e "  完整文档: ${GREEN}https://github.com/your-org/tradeToolkit/blob/main/docs/deploy_demo_system.md${NC}"
    echo ""
}
