...
def apply_fundamentals_analyst_fix():
    ...
    fundamentals_file = "d:\\code\\tradeToolkit\\tradingagents\\agents\\analysts\\fundamentals_analyst.py"
...
def apply_conditional_logic_fix():
    ...
    conditional_file = "d:\\code\\tradeToolkit\\tradingagents\\graph\\conditional_logic.py"
...
'''
    ...
    with open("d:\\code\\tradeToolkit\\test_level3_fix.py", 'w', encoding='utf-8') as f:
