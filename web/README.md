# tradeToolkit Web 管理界面

基于 Streamlit 构建的 Web 管理界面，提供直观的股票分析体验。支持多种 LLM 提供商和 AI 模型，用于学习、研究与策略实验。
...
REDDIT_USER_AGENT=tradeToolkit/1.0
```
...
1. 📖 查看 [完整文档](../docs/)
2. 🧪 运行项目内的测试用例或最小复现脚本
3. 💬 在你自己的仓库/项目管理工具中提交 Issue（附日志与复现步骤）
